...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("restx_sample ac15e01c-90ef-49a7-9b53-e85f19c9cd3d restx_sample -4541533608204693967".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in restx_sample package as a set of config entries
        return configLoader.fromResource("restx_sample/settings");
    }
